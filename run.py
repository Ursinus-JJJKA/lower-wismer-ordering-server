...
if __name__ == "__main__":
    ...
    if not os.path.exists("lwo.key") or not os.path.exists("lwo.crt"):
        generate_cmd = f'openssl req -x509 -newkey rsa:4096 -sha256 -days 365 -nodes -keyout lwo.key -out lwo.crt -subj "/CN=LWO_AutoGenerated" -addext "subjectAltName=IP:{get_ip()}"'
